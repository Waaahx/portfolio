...
import { MdOutlinePermIdentity, MdAddTask } from "react-icons/md";
...
import { GitHub, Skript, Java, Javascript, HTML, CSS, NodeJS, _React, MySql, Golang, Php, Gitea, Rust, Shell, Tailwind } from "../components/Generic/Tag";
...
const Bisou = () => (
  <Project
    ...
    tags={<><Skript /><Java /></>}
    project={"https://github.com/Waaahx/BisouPlugin"}
  />
);
...
const MCbuilder = () => (
  <Project
    ...
    Logo={<FaTerminal />}
    tags={<><Shell /><GitHub /></>}
    project={"https://github.com/Waaahx/minecraft_server_builder"}
  />
);
...
const Uwuid = () => (
  <Project
    ...
    Logo={<FaHeart />}
    tags={<><Golang /><GitHub /></>}
    project={"https://github.com/Waaahx/uwuid"}
  />
);
...
const DiscordBuilder = () => (
  <Project
    ...
    Logo={<FaRobot />}
    tags={<><Shell /><GitHub /></>}
    project={"https://github.com/Waaahx/discord-bot-builder"}
  />
);
...
const Up = () => (
  <Project
    name="Up"
    description="Up est un logiciel de type CRM développé pendant mes 2 ans d'alternance au Campus Saint Marc. Il permet de gérer les étudiants, les entreprises et les offres d'alternance."
    Logo={<FaRocket />}
...
const Portfolio = () => (
  <Project
    ...
    project={"https://github.com/Waaahx/portfolio"}
  />
);
...
const Taskboard = () => (
  <Project
    name="Taskboard"
    description="Mon premier projet en PHP, une todolist basique pour comprendre les bases du langages."
    Logo={<MdAddTask />}
    tags={<><Php /><_React /><GitHub /></>}
    project={"https://github.com/Waaahx/taskboard"}
  />
);
...
const FileManipulator = () => (
  <Project
    ...
    description="Un projet en php pour mieux comprendre la gestion des objest et l'utilisation de tests unitaires."
    Logo={<CiFileOn />}
    tags={<><Php /><GitHub /></>}
    project={"https://github.com/Waaahx/FileManipulator"}
  />
);
...
export const projects = [Up, Taskboard, FileManipulator, WebOs, Bisou, Uwuid, Endobot, MCbuilder, DiscordBuilder, Myls, NetCat, SmartRoad, Portfolio];